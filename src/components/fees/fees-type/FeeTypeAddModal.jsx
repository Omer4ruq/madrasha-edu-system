        ...
        <Modal isOpen={isAdd} onClose={onClose} width="w-2/3 md:w-1/2">
            ...
            <div className="my-8 space-y-3">
                <div className="space-y-2">
                    ...
                    <select className="bg-bgGray w-full rounded p-2 border-2 border-transparent focus:border-#DB9E30 focus:outline-none appearance-none" defaultValue="0" name="fee_type" id="fee_type">
                ...
                <div className="space-y-2">
                    ...
                    <select className="bg-bgGray w-full rounded p-2 border-2 border-transparent focus:border-#DB9E30 focus:outline-none appearance-none" defaultValue="1" name="status" id="status">
                ...
                <div className="space-y-2">
                    ...
                    <select className="bg-bgGray w-full appearance-none rounded p-2 border-2 border-transparent focus:border-#DB9E30 focus:outline-none" defaultValue="2024" name="admission_year" id="admission_year">
