            ...
            {hasAddPermission && (
              <div className="mb-6">
                <button
                  ...
                  className={`flex items-center w-full max-w-xs px-6 py-3 rounded-lg font-medium bg-[#DB9E30] text-[#441a05] transition-all duration-300 animate-scaleIn ${
            ...
            {hasAddPermission && configurations.length > 0 && (
              <div className="mb-6">
                <button
                  ...
                  className={`flex items-center px-6 py-3 rounded-lg font-medium bg-[#DB9E30] text-[#441a05] transition-all duration-300 animate-scaleIn ${isSubmitting ? 'cursor-not-allowed opacity-70' : 'hover:text-white btn-glow'}`}
                  disabled={isSubmitting}
                >
                  {isSubmitting ? (
                    <>
