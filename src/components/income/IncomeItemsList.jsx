...
const IncomeItemsList = ({ onEditClick, onDelete }) => {
  ...
  // Comment out Bengali date conversion for future use
  /*
  ...
  */
  ...
  // Comment out Bengali number formatting for future use
  /*
  ...
  */
  ...
  const generatePDFReport = () => {
    ...
    for (let i = 0; i < filteredItems.length; i += rowsPerPage) {
      incomePages.push(filteredItems.slice(i, i + rowsPerPage));
    }
    ...
    const htmlContent = `
      ...
      ${
        ...
        ${incomePages.map((pageItems, pageIndex) => `
          <div class="page-container">
            <div class="header">
              ...
              <h2 class="title">আয় আইটেম প্রতিবেদন</h2>
              ...
              <tbody>
                ${pageItems.map((item, index) => `
                  <tr style="${index % 2 === 1 ? '' : ''}">
                    ...
                    <td style="text-align: right; font-weight: bold;">${item.amount || '0'}</td>
                    <td>${academicYears.find((year) => year.id === item.academic_year)?.name || 'অজানা'}</td>
                  </tr>
                `).join('')}
              </tbody>
              ${pageIndex === incomePages.length - 1 ? `
                <tfoot>
                  <tr>
                    <td colspan="6">মোট আয়</td>
                    <td>${totalAmount}</td>
                    <td></td>
                  </tr>
                </tfoot>
            ...
            <div class="footer">
              ...
              <span>পৃষ্ঠা ${pageIndex + 1} এর ${incomePages.length}</span>
            </div>
          </div>
        `).join('')}
 <script>
