  ...
  if (isLoading || isListLoading) {
    return (
      <div className="flex items-center justify-center min-h-screen px-4">
        <div className="flex items-center gap-4 p-6 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl border border-white/20 animate-fadeIn">
    ...
    `}
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-10 animate-fadeIn w-full">
        ...
        <button
          ...
          className="relative inline-flex items-center px-6 py-3 bg-blue-600 text-white font-medium rounded-xl hover:bg-blue-700 btn-glow transition-all duration-300 animate-scaleIn bg-#DB9E30"
        >
          View Classes
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 ">
        ...
        <div className="lg:col-span-1 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl p-6 animate-fadeIn h-full border  border-white/20">
          <h3 className="text-lg font-semibold text-white">Select Classes</h3>
        ...
        <div className="lg:col-span-3 bg-white/10 backdrop-blur-md rounded-2xl shadow-xl p-6 animate-fadeIn max-h-[72vh] overflow-y-auto flex flex-col border border-white/20">
          ...
          <div className="flex justify-end mt-4">
            <button
              ...
              disabled={isCreating}
              className={`relative inline-flex bg-#DB9E30 items-center px-3 py-2 rounded-xl font-medium text-white transition-all duration-300 ${
                isCreating
